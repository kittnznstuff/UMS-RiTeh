...
def publish_grip_force():
  ...
  try:
    ...
    lin_coeff = rospy.get_param('~lin_coeff')
    square_coeff = rospy.get_param('~square_coeff')
    cubic_coeff = rospy.get_param('~cubic_coeff')
    fourth_ord_coeff = rospy.get_param('~fourth_ord_coeff')
    ...
    with Gdx as gdx_hd:
      ...
      gdx_hd.read(publisher=pub, measurement_type=measurement_type, lin_coeff=lin_coeff, square_coeff=square_coeff, cubic_coeff=cubic_coeff, fourth_ord_coeff=fourth_ord_coeff)
