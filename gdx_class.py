...
#  def read(self, publisher, measurement_type='grip'):
  def read(self, publisher, measurement_type='grip', lin_coeff=1 , square_coeff=0, cubic_coeff=0, fourth_ord_coeff=0):             
      ...
      while not rospy.is_shutdown(): 
        ...
        if self.device_hn.read():  
          ...
          for ts, id, value in zip(timestamps_iter, sig_id, data):
            ...
            force_data.grip_force = lin_coeff * x + square_coeff * (x**2) + cubic_coeff * (x**3) + fourth_ord_coeff * (x**4)
